...
file_path2 = path + 'local_sync_pbtask_only_log_t2_p2.txt'
file_path3 = path + 'local_sync_pbtask_only_log_t3_p3.txt'
file_path4 = path + 'local_sync_pbtask_only_log_t4_p4.txt'
file_path5 = path + 'local_sync_pbtask_only_log_t5_p5.txt'
file_path6 = path + 'local_sync_pbtask_only_log_t6_p6.txt'
file_path7 = path + 'local_sync_pbtask_only_log_t7_p7.txt'
file_path8 = path + 'local_sync_pbtask_only_log_t8_p8.txt'
file_path9 = path + 'local_sync_pbtask_only_log_t9_p9.txt'
file_path10 = path + 'local_sync_pbtask_only_log_t10_p10.txt' 
file_path11 = path + 'local_sync_pbtask_only_log_t11_p11.txt'
file_path12 = path + 'local_sync_pbtask_only_log_t12_p12.txt'
file_path13 = path + 'local_sync_pbtask_only_log_t13_p13.txt'
file_path14 = path + 'local_sync_pbtask_only_log_t14_p14.txt'
file_path15 = path + 'local_sync_pbtask_only_log_t15_p15.txt'
file_path16 = path + 'local_sync_pbtask_only_log_t16_p16.txt'
file_path17 = path + 'local_sync_pbtask_only_log_t17_p17.txt'
file_path18 = path + 'local_sync_pbtask_only_log_t18_p18.txt'
file_path19 = path + 'local_sync_pbtask_only_log_t19_p19.txt'
file_path20 = path + 'local_sync_pbtask_only_log_t20_p20.txt'
